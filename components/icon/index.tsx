...
const iconPackages: Record<string, unknown> = {
  // Ai,
  // Bs,
  // Bi,
  // Ci,
...
export default function Icon({
  ...
  const iconModule =
    iconPackage && typeof iconPackage === "object"
      ? (iconPackage as Record<string, unknown>)
      : null;
  const IconComponent = (iconModule?.[name] as ElementType | undefined) ?? null;
