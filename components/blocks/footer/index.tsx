        ...
        <footer>
            ...
            {footer.copyright && (
              <p>
                ...
                {process.env.NEXT_PUBLIC_SHOW_POWERED_BY === "false" ? null : (
                  <a
                    href="https://shipany.ai/i/HALUN88"
                    target="_blank"
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 text-center">
            <p className="text-xs text-muted-foreground max-w-4xl mx-auto">
              This website is not an official Disney website. We are an independent platform providing information and resources about Disney Solitaire games. All Disney characters, names, and related properties are trademarks of The Walt Disney Company.
            </p>
          </div>
        </footer>
      </div>
