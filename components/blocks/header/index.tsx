    ...
    <section className="py-3" aria-label="Main navigation">
      <div className="md:max-w-7xl mx-auto px-4">
        <nav
          ...
          role="navigation"
          aria-label={`${header.brand?.title || 'Disney Solitaire'} main navigation`}
        >
          <div className="flex items-center gap-6">
            <a
              href={header.brand?.url || ""}
              className="flex items-center gap-2"
              aria-label={`${header.brand?.title || 'Disney Solitaire'} homepage`}
              title={`${header.brand?.title || 'Disney Solitaire'} - Go to homepage`}
            >
              {header.brand?.logo?.src && (
                <img
                  src={header.brand.logo.src}
                  alt={header.brand.logo.alt || `${header.brand?.title || 'Disney Solitaire'} logo`}
                  className="w-8"
                  loading="eager"
                  width="32"
                  height="32"
